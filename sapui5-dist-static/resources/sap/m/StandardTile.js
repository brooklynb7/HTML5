...
sap.m.StandardTile.prototype._getImage=function(){var i=this.getId()+"-img";var s=jQuery.device.is.phone?"1.3rem":"2rem";var p={src:this.getIcon(),height:s,width:s,size:s,densityAware:this.getIconDensityAware()};this._oImageControl=sap.m.ImageHelper.getImageControl(i,this._oImageControl,this,p);return this._oImageControl};
