...
sap.m.Bar.prototype._updatePosition = function() {
	...
	if(bContentLeft) {
		this._sResizeListenerIdLeft = sap.ui.core.ResizeHandler.register($leftBar[0], jQuery.proxy(this._updatePosition, this));
	}
	if(bContentMiddle) {
		this._sResizeListenerIdMid = sap.ui.core.ResizeHandler.register($midBarPH[0], jQuery.proxy(this._updatePosition, this));
	}
	if(bContentRight) {
		this._sResizeListenerIdRight = sap.ui.core.ResizeHandler.register($rightBar[0], jQuery.proxy(this._updatePosition, this));
	}
};