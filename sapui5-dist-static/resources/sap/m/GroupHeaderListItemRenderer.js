...
sap.m.GroupHeaderListItemRenderer.renderLIContent=function(r,l,t){var T=l.getTitle();t&&r.write("<td tabindex='-1' class='sapMGHLICell' colspan='"+(t.getColSpan())+"'>");if(T){t&&r.write("<div class='sapMLIBContent sapMLIBContentMargin'>");r.write("<label for='"+l.getId()+"-value' class='sapMGHLITitle'>");r.writeEscaped(T);var c=l.getCount();if(c!==undefined&&c!==""){r.writeEscaped(" ("+c+")")}r.write("</label>");t&&r.write("</div>")}t&&r.write("</td>")};
