...
jQuery.sap.declare("sap.ui.core.support.plugins.Debugging");
...
(function($) {
	...
	sap.ui.core.support.Plugin.extend("sap.ui.core.support.plugins.Debugging", {
		constructor: function(oSupportStub) {
			sap.ui.core.support.Plugin.apply(this, ["sapUiSupportDebugging", "Debugging", oSupportStub]);
	...
	sap.ui.core.support.plugins.Debugging.prototype.init = function(oSupportStub) {
	...
	sap.ui.core.support.plugins.Debugging.prototype.exit = function(oSupportStub) {
	...
	sap.ui.core.support.plugins.Debugging.prototype.renderContainer = function() {
	...
	sap.ui.core.support.plugins.Debugging.prototype.renderClasses = function() {
	...
	sap.ui.core.support.plugins.Debugging.prototype.renderMethods = function(mMethods) {
	...
	sap.ui.core.support.plugins.Debugging.prototype.onsapUiSupportDebuggingReceiveClasses = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype.onsapUiSupportDebuggingReceiveClassMethods = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._autoComplete = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._onAddClassClicked = function() {
	...
	sap.ui.core.support.plugins.Debugging.prototype._onRemoveClass = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._onAddBreakpointClicked = function() {
	...
	sap.ui.core.support.plugins.Debugging.prototype._onRemoveBreakpoint = function(oEvent) {
		this.changeBreakpoint($("#sapUiSupportDebuggingClassList li.selected span.className").text(),
				$(oEvent.target).prev().text(),
				$(oEvent.target).parent("li").attr("data-method-type"), false);
	};

	sap.ui.core.support.plugins.Debugging.prototype._updateSelectOptions = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._selectOptionsChanged = function (oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._onSelectClass = function(oEvent) {
	...
	sap.ui.core.support.plugins.Debugging.prototype._isClassSelected = function() {
		var selected = false;
	...
	sap.ui.core.support.plugins.Debugging.prototype.changeBreakpoint = function(className, methodName, type, active) {
