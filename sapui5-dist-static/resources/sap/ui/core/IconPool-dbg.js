...
(function(){
	 ...
	 * @public
	 */
	sap.ui.core.IconPool.addIcon = function(iconName, collectionName, fontFamily, content, overWrite, skipMirroring){
	...
	sap.ui.core.IconPool._calcAbsPath = function(sRelative, sBase){
		// remove the URL parameters for base URL 251 
	...
	jQuery.each(aIconNames, function(index, name){
		sap.ui.core.IconPool.addIcon(name, undefined, sapIconFamily, aIconCodes[index], false, sap.ui.core.IconPool._isMirroringSkipped(name));
	});
}());
