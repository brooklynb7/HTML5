 ...
 */
jQuery.sap.declare("sap.ui.core.search.OpenSearchProvider");jQuery.sap.require("sap.ui.core.library");jQuery.sap.require("sap.ui.core.search.SearchProvider");sap.ui.core.search.SearchProvider.extend("sap.ui.core.search.OpenSearchProvider",{metadata:{library:"sap.ui.core",properties:{"suggestUrl":{type:"sap.ui.core.URI",group:"Misc",defaultValue:null},"suggestType":{type:"string",group:"Misc",defaultValue:'json'}}}});jQuery.sap.require("jquery.sap.encoder");
