...
jQuery.sap.require("sap.ui.core.util.serializer.HTMLViewSerializer");
jQuery.sap.require("sap.ui.core.util.serializer.XMLViewSerializer");
...
sap.ui.core.util.serializer.ViewSerializer.prototype._serializeRecursive = function (oControl) {
	...
	if (oControl instanceof this._oWindow.sap.ui.core.mvc.View) {
		...
		if (oViewSerializer) {
			// TODO: This is a hack - right now we have no information about the view name. That is why we use the controller name.
			var oViewName = oControl.getControllerName();
