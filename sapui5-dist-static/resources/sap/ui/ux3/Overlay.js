...
sap.ui.ux3.Overlay.prototype._initDom=function(f,F,a){var s=jQuery(".sapUiUx3Shell").control();this._oShell=s.length?s[0]:null;s=this._oShell;jQuery.sap.byId(this.getId()).css("position","fixed");if(s){this._bFocusEventsRegistered=true;s.syncWithCanvasSize(this.getId(),true,f,F,a);jQuery.sap.byId(this.getId()+"-firstFocusDummyPaneFw").attr("tabindex","0").focusin(jQuery.proxy(s.focusFirstHdr,s));jQuery.sap.byId(this.getId()+"-firstFocusDummyPaneBw").attr("tabindex","0").focusin(jQuery.proxy(s.focusLastTool,s));jQuery.sap.byId(this.getId()+"-LastFocusDummyPane").attr("tabindex","0").focusin(jQuery.proxy(s.focusPaneStart,s))}else{jQuery.sap.byId(this.getId()).css("bottom","0px").css("top","0px").css("left","0px").css("right","0px")}};
