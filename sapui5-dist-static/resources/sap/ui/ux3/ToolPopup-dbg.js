...
sap.ui.ux3.ToolPopup.ARROW_ICONS = {
	right : sap.ui.core.IconPool.getIconURI("slim-arrow-right"),
	//left : sap.ui.core.IconPool.getIconURI("slim-arrow-left"),
	left : sap.ui.core.IconPool.getIconURI("down"),
	up : sap.ui.core.IconPool.getIconURI("slim-arrow-up"),
	down : sap.ui.core.IconPool.getIconURI("slim-arrow-down")
};
...
sap.ui.ux3.ToolPopup.prototype.init = function() {
	...
	this._oArrowIcon = new sap.ui.core.Icon({
		// using left arrow per default
		src: sap.ui.ux3.ToolPopup.ARROW_ICONS.left,
	}).addStyleClass("sapUiUx3IconFontArrow");
};
