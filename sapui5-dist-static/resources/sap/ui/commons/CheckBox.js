...
sap.ui.commons.CheckBox.prototype.onclick=function(e){if(!!sap.ui.Device.browser.internet_explorer&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",0).addClass("sapUiCbFoc")}this.userToggle(e)};
sap.ui.commons.CheckBox.prototype.onfocusout=function(e){if(!!sap.ui.Device.browser.internet_explorer&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",-1).removeClass("sapUiCbFoc")}};
