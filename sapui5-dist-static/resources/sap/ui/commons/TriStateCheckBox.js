...
sap.ui.commons.TriStateCheckBox.prototype.onclick=function(e){if(!!sap.ui.Device.browser.internet_explorer&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",0).addClass("sapUiTriCbFoc")}this.userToggle(e)};
sap.ui.commons.TriStateCheckBox.prototype.onfocusout=function(e){if(!!sap.ui.Device.browser.internet_explorer&&(!this.getEnabled())){jQuery.sap.byId(this.getId()).attr("tabindex",-1).removeClass("sapUiTriCbFoc")}};
