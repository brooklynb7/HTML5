...
sap.ui.unified.ShellOverlayRenderer.renderSearch=function(r,c){var w=c._getSearchWidth();var s="";if(w>0&&c._opening){s="style='width:"+w+"px'"}r.write("<div id='"+c.getId()+"-search' class='sapUiUfdShellOvrlySearch' "+s+">");var S=c.getSearch();if(S){r.renderControl(S)}r.write("</div>")};
