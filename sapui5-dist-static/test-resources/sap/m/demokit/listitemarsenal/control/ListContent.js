sap.ui.core.Control.extend("arsenal.control.ListContent", {
...
arsenal.control.ListContent.prototype.setImage = function(sSrc){
	this._image.setSrc(sSrc);
	this.setProperty("image", sSrc, true);
	return this;
};

arsenal.control.ListContent.prototype.ontap = function(){
	this.fireMyTap({});
};
