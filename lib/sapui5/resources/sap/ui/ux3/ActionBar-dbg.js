 ...
 * @static
 */
sap.ui.ux3.ActionBar.getMetadata()._mHiddenAggregations = {
	"_businessActionButtons": {multiple: true, type: "sap.ui.commons.Button"},
	"_socialActions": {multiple: true, type: "sap.ui.ux3.ThingAction"}
};	
