...
sap.ui.ux3.ShellRenderer.render = function(oRenderManager, oControl) {
	...
	rm.write("<img id='", oControl.getId(), "-bgImg' class='sapUiUx3ShellBgImg' src='");
	...
	// write pane bar
	var tabIndex = oControl._tiOpen ? " tabindex='0'" : "";
	rm.write("<span class='sapUiUx3ShellFocusDummy' id='" + oControl.getId() + "-focusDummyPane'" + tabIndex + "></span>");
	rm.write("<aside id='" + sId + "-paneBar' class='sapUiUx3ShellPaneBar" + (bPaneOpen ? " sapUiUx3ShellPaneBarOpen" : "") + "' role='complementary' style='width:" + iPaneWidthPlus + "px;'>");
