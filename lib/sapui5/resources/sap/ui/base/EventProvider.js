...
sap.ui.base.EventProvider.prototype.detachEvent=function(e,f,l){var E=this.mEventRegistry[e];if(!E){return this}for(var i=0,L=E.length;i<L;i++){if(E[i].fFunction===f&&E[i].oListener===l){E.splice(i,1);break}}if(E.length==0){delete this.mEventRegistry[e]}this.fireEvent(sap.ui.base.EventProvider.M_EVENTS.EventHandlerChange,{EventId:e,type:'listenerDetached'});return this};
sap.ui.base.EventProvider.prototype.fireEvent=function(e,p,a,E){if(typeof p=="boolean"){E=a;a=p}var b=this.mEventRegistry[e],P=false,o,c,I;if(b&&jQuery.isArray(b)){b=b.slice();o=this.oEventPool.borrowObject(e,this,p);for(var i=0,l=b.length;i<l;i++){I=b[i];I.fFunction.call(I.oListener||this,o,I.oData)}if(E){c=this.getEventingParent();while(c&&!o.bCancelBubble){b=c.mEventRegistry[e];if(b&&b instanceof Array){b=b.slice();for(var i=0,l=b.length;i<l;i++){I=b[i];I.fFunction.call(I.oListener||c,o,I.oData)}}c=c.getEventingParent()}}P=o.bPreventDefault;this.oEventPool.returnObject(o)}if(a){return!P}else{return this}};
