...
sap.m.GrowingList.prototype._getTrigger = function(oId) {
	...
	var sTriggerText = sap.ui.getCore().getLibraryResourceBundle("sap.m")
			.getText("LOAD_MORE_DATA");
	...
	var _trigger = this._trigger || new sap.m.CustomListItem({
						...
						formatter : function() {
							return "<div class='sapMSLIDiv sapMGrowingListTrigger'>" + 
										...
										"<div class='sapMGrowingListDescription'>" + 
											"<p class='sapMSLIDescription' id='" + oId + "-itemInfo'>" + that._getListItemInfo() + "</p>" + 
										"</div>" + 
									"</div>";
						}
					},
		...
		type : sap.m.ListType.Active}).setParent(this, null, true).attachTap(this._tap);
